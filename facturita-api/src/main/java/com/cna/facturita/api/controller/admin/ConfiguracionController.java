...
import com.cna.facturita.dto.auth.ConfiguracionDTO;
...
public class ConfiguracionController {
    ...
    private Configuracion toEntity(ConfiguracionDTO dto) {
        ...
        config.setSoapTypeId(dto.soapTypeId());
        ...
        config.setHabilitarWhatsapp(dto.habilitarWhatsapp());
        config.setRegexPasswordClient(dto.regexPasswordClient());
        return config;
    }
